...
**출시됨** (2026-08-27). Phase 0.5 실측으로 수익 모델의 두 전제를 확인하고 넘어왔다:

1. **광고를 세션당 몇 번 틀 수 있는가** ★ — **8/8 성공.** 막히는 지점이 없었다
2. 미니앱에서 **쉐어링크 복귀**가 되는가 — **복귀된다.** 돌아와도 세션이 살아 있다

실측 도구(`Probe` 화면)는 소임을 다해 걷었다. 결과와 근거는 [plan.md](plan.md)에 있다.
