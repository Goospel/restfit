...
- [T-231](troubleshooting/T-231.md) · 오래된 워크트리에서 vitest가 「15 files passed」 초록을 찍었지만 실제로는 4파일이 아예 안 돌았다 — devDeps 빠진 node_modules에서 워커 기동 실패가 unhandled error로 묻힌다
